...
const Contact = () => {
  ...
  const postData = async (e) => {
    ...
    const res = await fetch(
      "https://hangry-food-app-default-rtdb.firebaseio.com/contactform.json",
      {
        method: "POST",
        headers: {
    ...
    <section className="body-font relative text-black mt-8">
      <div className="container mx-auto px-5 py-24">
        ...
        <div className="mx-auto md:w-2/3 lg:w-1/2">
          <div>
            <form className="-m-2 flex flex-wrap" method="POST">
              ...
              <div className="w-full p-2">
                <button
                  className="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none active:scale-95"
                  onClick={postData}
                >
                  Send
                </button>
